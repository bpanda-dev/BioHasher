...
uint32_t g_ANN_MAX_B = 5; // Maximum value of b (hashes per table) to test in the Approx Nearest Neighbour test. Adjust as needed.
uint32_t g_ANN_MAX_R = 7; // Maximum value of r (number of tables) to test in the Approx Nearest Neighbour test. Adjust as needed.
