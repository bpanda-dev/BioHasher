...
static void LSHCollisionTestInnerInnerWorker(
    const HashInfo *hinfo, uint32_t N_hash, HashFn hash, seed_t HashSeed,
    SequenceRecordsWithMetadataStruct &sequenceRecordsforTest,
    const std::vector<UnionBitVectorsStruct> *precomputedVectors,
