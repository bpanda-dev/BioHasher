...
def main():
    ...
    if not args.no_scatter:
        ...
        plot_color_scatter(df, xlabel=similarity, save_filename = savename, show_plot=False)
        # print(f"Saved: {savename}")
    ...
    if not args.no_scatter:
        ...
        plot_monocolor_scatter(df, xlabel=similarity, save_filename = savename, show_plot=False)
        # print(f"Saved: {savename}")
    ...
    if not args.no_boxplot:
        ...
        plot_hash_collision_boxplots(df, xlabel=similarity, save_filename = savename, show_plot=False)
        # print(f"Saved: {savename}")
